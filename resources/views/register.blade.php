...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-msg ul { list-style: none; display: flex; flex-direction: column; gap: 4px; }
        .success-msg {
...
<div class="auth-shell">
    <div class="auth-visual">
        ...
        <div class="auth-visual-body">
            <div class="auth-visual-title">Rejoignez la plateforme LMC.</div>
            <div class="auth-visual-sub">
                Créez votre compte pour rejoindre l'équipe de consultants — votre
                demande sera examinée et activée par un administrateur.
            </div>
        </div>
    ...
    <div class="auth-form-panel">
        <div class="login-wrap">
            <div class="login-card">
                ...
                <div class="login-title">Demander un accès</div>
                <div class="login-sub">Votre compte sera activé après validation par un administrateur</div>
                    ...
                    <div class="form-group" style="display: flex; gap: 12px;">
                        <div style="flex: 1;">
                            ...
                            <div class="input-wrap">
                                ...
                                <input type="text" name="prenom" class="form-input @error('prenom') is-invalid @enderror"
                                    placeholder="Prénom" value="{{ old('prenom') }}" required autofocus>
                            </div>
                        </div>
                        <div style="flex: 1;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrap">
                            ...
                            <input type="email" name="email" class="form-input @error('email') is-invalid @enderror"
                                placeholder="votre@email.com" value="{{ old('email') }}" required autocomplete="email">
                        </div>
                    </div>
